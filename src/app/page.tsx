    ...
    <>
      ...
      <section className="relative h-[100vh] flex items-center justify-center text-center text-white overflow-hidden">
        ...
        <div className="relative z-10 px-4 mt-12">
          ...
          >
            <h1
              className="space-mono-bold text-[42px] md:text-[68px] tracking-tighter uppercase leading-[1.05] text-[#F0F2F7]"
      ...
      <section
        id="prodCards"
        className="py-12 sm:py-[98px] bg-[#090D12] min-h-screen"
      >
      ...
      <section id="about" className="bg-[#090D12] text-center relative">
        ...
        <div
          aria-hidden="true"
          className="h-screen sticky top-0 missionSection"
        ></div>

        {/* Контент поверх фона */}
        <div className="relative z-10 h-[400vh] -mt-[100vh]">
          {" "}
          {/* Такая же высота как у MissionAnimation */}
      ...
      <section className="py-8 sm:py-12 bg-[#FFFFFF]">
        <div className="mx-auto max-w-[1280px] px-4 sm:px-6 lg:px-8">
          <h1 className="text-[28px] md:text-[45px] text-[#0F141C] font-[500]">
            {t("contact.title")}
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <div className="hidden md:block space-y-12 max-w-[350px] text-[#0F141C]">
              <div>
                ...
                <p
                  className="mt-2 text-lg font-[400] opacity-50"
