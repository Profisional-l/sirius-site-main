    ...
    >
      ...
      <div className="sticky top-0 h-screen overflow-visible">
        <motion.div
          ...
          className={`${services[0].bgColor} absolute left-0 right-0 top-0 mx-auto w-full max-w-[1280px] min-h-screen flex flex-col overflow-visible rounded-t-[17px] rounded-b-none transform-gpu will-change-transform ${isMobile ? "shadow-none" : "shadow-lg"}`}
        >
          <div
            aria-hidden="true"
        ...
        <motion.div
          ...
          className={`${services[1].bgColor} absolute left-0 right-0 top-0 mx-auto w-full max-w-[1280px] min-h-screen flex flex-col overflow-visible rounded-t-[17px] rounded-b-none transform-gpu will-change-transform ${isMobile ? "shadow-none" : "shadow-lg"}`}
        >
          <div
            aria-hidden="true"
